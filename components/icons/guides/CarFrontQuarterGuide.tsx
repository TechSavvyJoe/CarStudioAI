...
export const CarFrontQuarterGuide: React.FC<GuideProps> = ({ vehicleType = 'sedan', ...props }) => {
    ...
    return (
        <GuideContainer {...props}>
            <g filter="url(#guide-glow)" stroke="#04a1f9" fill="none" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                ...
                <circle cx="310" cy={roofHeight} r="5" fill="#04a1f9" className="animate-breathing-glow" />
                <circle cx={150 + length - 50} cy={bodyHeight} r="5" fill="#04a1f9" />
                <circle cx={150 + length - 80} cy={roofHeight} r="5" fill="#04a1f9" />
            </g>
        </GuideContainer>
    );
};